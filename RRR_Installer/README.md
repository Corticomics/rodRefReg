...
Failed to install Python packages: Command '['pip3', 'install', 'requests', 'slack_sdk']' returned non-zero exit status 1.
Setting up the application...
Saving configuration...
Failed to save configuration: Command '['pkexec', '/home/conelab-rrr2/Documents/GitHub/rodRefReg/RRR_Installer/dist/installer_main', 'installer_backend.py', 'create_config_file', 'settings_temp.py', '/etc/rrr/settings.py']' returned non-zero exit status 1.
