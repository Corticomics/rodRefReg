# app/ui/run_stop_section.py

from PyQt5.QtWidgets import (
    QWidget, QVBoxLayout, QPushButton, QLabel, QLineEdit, QDateTimeEdit, QTabWidget, QFormLayout
)
...
class RunStopSection(QWidget):
    ...
    def change_relay_hats(self):
        ...
        if self.advanced_settings and 'relay_pairs' in self.advanced_settings.settings:
