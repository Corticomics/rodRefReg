        ...
        if self._solenoid_controller is None:
            try:
                ...
                self._solenoid_controller = SolenoidController(
                    relay_handler, master_id, cage_map
                )
    ...
    def _on_close_master_clicked(self):
        ...
        try:
            ...
            if controller.close_master():
                ...
                QMessageBox.warning(self, "Hardware Error",
                    "Failed to close master solenoid.")
    ...
    def _on_open_cage_clicked(self):
        ...
        try:
            ...
            if controller.open_cage(cage_id):
                ...
                QMessageBox.warning(self, "Hardware Error",
                    f"Failed to open {self.cage_selector.currentText()}.")
    ...
    def _on_close_cage_clicked(self):
        ...
        try:
            ...
            if controller.close_cage(cage_id):
                ...
                QMessageBox.warning(self, "Hardware Error",
                    f"Failed to close {self.cage_selector.currentText()}.")
    ...
    def _populate_cage_selector(self):
        ...
        try:
            ...
            for cage_id, relay_id in sorted(cage_map.items()):
                self.cage_selector.addItem(
                    f"Cage {cage_id} (Relay {relay_id})", 
                    cage_id
                )
