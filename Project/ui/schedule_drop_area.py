    ...
    def dropEvent(self, event):
        ...
        if data.hasFormat('application/x-schedule'):
            try:
                ...
                self.current_schedule.relay_unit_assignments = schedule_detail.get(
                    'relay_unit_assignments', {}
                )
                self.current_schedule.desired_water_outputs = schedule_detail.get(
                ...
                if self.current_schedule.delivery_mode.lower() == 'instant':
                    ...
                    for delivery in deliveries:
                        ...
                        self.current_schedule.add_instant_delivery(
                            animal_id, delivery_time, volume, relay_unit_id
                        )
                ...
                print(
                    f"Emitting schedule_dropped signal with schedule: {self.current_schedule.name}"
                )
        ...
        try:
            ...
            if schedule.delivery_mode.lower() == 'instant':
                ...
                for delivery in deliveries:
                    ...
                    animal_id, lab_id, name, datetime_str, volume, completed, relay_unit_id = (
                        delivery
                    )
                    ...
                    animal_deliveries[animal_id]['deliveries'].append(
                        {'datetime': delivery_time, 'volume': volume}
                    )
                ...
                for animal_id in animal_ids:
                    ...
                    if animal:
                        ...
                        desired_output = schedule_details['desired_water_outputs'].get(
                            str(animal_id), 0
                        )
