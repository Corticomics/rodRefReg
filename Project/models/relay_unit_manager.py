...
class RelayUnitManager:
    ...
    def _initialize_solenoid_mode(self):
        ...
        if not cage_relays:
            print(f"[RelayUnitManager] No cage_relays configured, auto-generating for {num_hats} HAT(s)")
        ...
        print(f"[RelayUnitManager] Solenoid mode initialized: {len(self.relay_units)} cages (master on relay {master_id})")
